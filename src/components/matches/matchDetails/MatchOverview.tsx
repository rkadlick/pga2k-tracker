  ...
  return (
    <div className="bg-[--card-bg] border border-[--border] overflow-hidden rounded-lg">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg leading-6 font-semibold text-[--foreground] flex items-center">
      ...
      <div className="border-t border-[--border]">
        <div className="px-4 py-5 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[--input-bg] rounded-lg p-4 border border-[--border]">
            <h4 className="text-base font-medium text-[--foreground] mb-3">{match.your_team}</h4>
            <ul className="space-y-2">
              <li className="text-sm text-[--muted] flex items-center justify-between">
          ...
          {/* Opponent Team */}
          <div className="bg-[--input-bg] rounded-lg p-4 border border-[--border]">
            <h4 className="text-base font-medium text-[--foreground] mb-3">{match.opponent_team}</h4>
            <ul className="space-y-2">
              <li className="text-sm text-[--muted] flex items-center justify-between">
                <span>{match.opponent1_name}</span>
                <span>Rating: {match.opponent1_rating}</span>
              </li>
              <li className="text-sm text-[--muted] flex items-center justify-between">
                <span>{match.opponent2_name}</span>
                <span>Rating: {match.opponent2_rating}</span>
              </li>
            </ul>
          </div>
        </div>
